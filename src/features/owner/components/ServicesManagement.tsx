      ...
      {showForm ? (
        <View className="space-y-4 mb-2">
          ...
          <View className="flex-row gap-3 pt-4">
            ...
            >
              <Text className="text-slate-700 font-black text-xs uppercase tracking-widest">
                Cancel
              </Text>
            </Pressable>
          </View>
        ...
        <View className="space-y-3">
          {services.map((s) => (
            <View
              key={s.id}
              className="bg-slate-50 border border-slate-200/80 rounded-2xl p-4 flex-row justify-between items-center mb-3"
            >

...
export const OwnerBookingDetailModal: React.FC<OwnerBookingDetailModalProps> = ({
  ...
  const serviceDuration = React.useMemo(() => {
    if (b.services && b.services.length > 0) {
      return b.services.reduce((sum: number, s: any) => sum + (s.duration || s.duration_minutes || 30), 0);
    }
              ...
              {(b.customer_phone || b.customer_profile?.phone) && (
                <View className="flex-row gap-x-3 mt-5 pt-4 border-t border-slate-50">
                  ...
                  >
                    ...
                    <Text className="text-slate-800 font-bold text-xs uppercase tracking-wider">Call Client</Text>
                  </TouchableOpacity>
                  ...
                  >
                    ...
                    <Text className="text-emerald-800 font-bold text-xs uppercase tracking-wider">WhatsApp</Text>
                  </TouchableOpacity>
                </View>
              )}
            </View>

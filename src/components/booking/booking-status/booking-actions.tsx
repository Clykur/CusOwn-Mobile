...
function BookingActionsComponent({
  ...
  const appointmentDateTime = (() => {
    ...
    const startTime = startTimeRaw.includes("T")
      ...
      : new Date(
          `${booking.slot.date}T${startTimeRaw}`,
        );
  ...
  const isActionDisabled =
    !appointmentDateTime || msUntilAppointment < THIRTY_MINUTES_IN_MS;

  const isCancellationTooLate =
    canCancelByStatus && isActionDisabled;
...
export const BookingActions = memo(

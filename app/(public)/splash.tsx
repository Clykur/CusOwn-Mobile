    ...
    <PremiumBackground>
      <View className="flex-1 items-center justify-center px-luxury">
        ...
        <View className="h-16 mt-12 items-center justify-center">
           <Animated.Text style={phraseStyle} className="text-accent-premium text-xl font-semibold italic text-center">
             {PHRASES[currentPhraseIndex]}
           </Animated.Text>
        </View>
      </View>
      
      <AnimatedSection direction="up" delay={2000} className="absolute bottom-16 w-full items-center">

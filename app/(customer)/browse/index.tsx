...
export default function CustomerBrowseScreen() {
  ...
  const renderCategoryChip = ({
    ...
    return (
      <Pressable
        className={`px-6 py-2.5 rounded-full border mr-3 ${isActive
    ...
    <PremiumBackground>
      <SafeAreaView className="flex-1" edges={['top']}>
        <View className="px-luxury pt-5 pb-2">
          ...
          <Text className="text-slate-900 text-3xl font-black tracking-tight">Discover Your Next Experience</Text>
        </View>
        {/* Search + Location */}
            ...
            <View className="flex-row items-center justify-between">
              ...
              <View className="flex-row items-center flex-1">
                ...
                <View className="ml-2 flex-1">
                  ...
                  <TextInput
                    value={useCurrentLocation ? (userLocation?.city || 'Detecting location...') : manualLocation}
                    onChangeText={(val) => {
              ...
              <Pressable
                ...
                className={`w-10 h-10 rounded-full items-center justify-center ml-3 ${useCurrentLocation ? 'bg-accent-premium' : 'bg-black'
                  }`}
              >
                {locationLoading ? (
                  <ActivityIndicator
        ...
        {isLoading ? (
          ...
          <View className="flex-1 justify-center items-center px-luxury">
            <GlassCard className="items-center w-full bg-white border border-slate-200 shadow-sm">
              ...
              >
                <Text className="text-accent-premium font-bold">
                  Retry Discovery
                </Text>
              </Pressable>
            </GlassCard>
            ...
            ListEmptyComponent={
              ...
              >
                ...
                <Text className="text-slate-500 text-center px-12 text-base">
                  Try adjusting your search filters or queries to
                  find your next curated experience.
                </Text>
              </AnimatedSection>
            }
          />
